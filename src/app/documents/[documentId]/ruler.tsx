                ...
                <div className="absolute inset-x-0 bottom-0 h-full">
                    <div className="relative h-full w-[816px]">
                        {markers.map((marker) => {
                            ...
                            return (
                                <div key={marker} className="absolute bottom-0 left-[${position}]" style={{left: `${position}px`}}>
                                    {marker % 10 == 0 && (
                                        <>
...
const Marker = ({
    ...
    return (
        ...
        onDoubleClick={onDoubleClick}>
            <FaCaretDown className="absolute left-1/2 top-0 h-full fill-blue-500 -translate-x-1/2 transform"/>
