  ...
  return (
    <div className="flex items-center gap-x-0.5">
      ...
      {isEditing ? (
        ...
        className="h-7 w-10 shrink-0 text-sm text-center border border-neutral-400  rounded-sm bg-transparent focus:outline-none focus:ring-0"/>
      ): (
        <button 
        onClick={() => {
          setIsEditing(true);
        ...
        className="h-7 w-10 shrink-0 text-sm text-center border border-neutral-400  rounded-sm bg-transparent cursor-text">
          {currentFontSize}
        </button>
      )}
      <button className="h-7 w-7 shrink-0 flex items-center justify-center rounded-sm hover:bg-neutral-200/80"
  ...
  return (
    <DropdownMenu onOpenChange={(open) => {
      ...
      <DropdownMenuContent className="p-2.5 flex items-center gap-x-2">
        <Input placeholder="Paste link" value={value}
