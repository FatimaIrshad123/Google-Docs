...
import { Menubar,  MenubarItem, MenubarMenu, MenubarShortcut, MenubarSubContent, MenubarSubTrigger, MenubarTrigger,MenubarSeparator, MenubarSub, MenubarContent } from "@/components/ui/menubar"
                                ...
                                <MenubarContent>
                                    <MenubarSub>
                                        ...
                                        <MenubarItem onClick={() => editor?.chain()?.focus().unsetAllMarks().run()}>
                                            ...
                                            Clear formating <MenubarShortcut>⌘I</MenubarShortcut>
                                        </MenubarItem>
                                    </MenubarSub>
                                </MenubarContent>
                            </MenubarMenu>
